...
public class ObjectsSortWordPairsLambda {
	...
	public static void main(String[] args) {
		...
		Collections.sort(transArray, (a, b) -> a.getEnglishWord().compareTo(b.getEnglishWord()));
		...
		Collections.sort(transArray, (a, b) -> a.getFinnishWord().compareTo(b.getFinnishWord()));
		for (int i = 0; i < transArray.size(); i++) {
			System.out.println(transArray.get(i));
		}
	}
